...
public class TC_No_ScreenshotOnTestPass extends TestBase{
	
	@Test
	public static void TestScenario_PassCondition() throws InterruptedException
	{
	 		dr.get("http://automationpractice.com/index.php");
		   	Thread.sleep(1000);
		   	
		   	dr.findElement(By.className("login")).click();
		   	dr.findElement(By.id("email_create")).sendKeys("prerana13@yopmail.com");
			...
			dr.findElement(By.id("company")).sendKeys("Achary");
		   	...
		   	dr.findElement(By.xpath("//span[contains(text(),'Register')]")).click();
